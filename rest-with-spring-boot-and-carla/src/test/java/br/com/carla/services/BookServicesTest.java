...
import br.com.carla.unitetests.mapper.mocks.MockBook;
...
class BookServicesTest {
    ...
    void findById() {
        ...
        assertEquals(250.26, result.getPrice());
    ...
    void findByAll() {
        ...
        List<BookDTO> books = services.findByAll();
        ...
        assertEquals(250.26, bookOne.getPrice());
        ...
        assertNotNull(bookFour.getLinks().stream().anyMatch(link -> link.getRel().value().equals("self")
                && link.getHref().endsWith("/book/v1/4")
                && link.getType().equals("GET")
        ));
        ...
        assertEquals(250.26, bookFour.getPrice());
        ...
        assertNotNull(bookSeven.getLinks().stream().anyMatch(link -> link.getRel().value().equals("self")
                && link.getHref().endsWith("/book/v1/7")
                && link.getType().equals("GET")
        ));
        ...
        assertEquals(250.26, bookSeven.getPrice());
